...
## Saving Result ## ## ## ## ## ## ## ## ## ## ## ## ## ## ##
output_path = "/dss/dsshome1/0C/ra67jip2/llm-consistency/data/res1_raw_base-models.csv"
...
## Saving Result ## ## ## ## ## ## ## ## ## ## ## ## ## ## ##
output_path = "/dss/dsshome1/0C/ra67jip2/llm-consistency/data/res2_raw_base-models.csv"
results = questions_df.drop(columns=['llm_prompt'])
results.to_csv(output_path, index=False)
print(f"\nResults saved to {output_path}")
...
## Saving Result ## ## ## ## ## ## ## ## ## ## ## ## ## ## ##
output_path = "/dss/dsshome1/0C/ra67jip2/llm-consistency/data/res3_raw_base-models.csv"
results = questions_df.drop(columns=['llm_prompt'])
results.to_csv(output_path, index=False)
print(f"\nResults saved to {output_path}")
...
## Saving Result ## ## ## ## ## ## ## ## ## ## ## ## ## ## ##
output_path = "/dss/dsshome1/0C/ra67jip2/llm-consistency/data/res4_raw_base-models.csv"
results = questions_df.drop(columns=['llm_prompt'])
results.to_csv(output_path, index=False)
print(f"\nResults saved to {output_path}")
