...
## Saving Result ## ## ## ## ## ## ## ## ## ## ## ## ## ## ##
output_path = "/dss/dsshome1/0C/ra67jip2/llm-consistency/data/res1_shuffled_raw.csv"
...
## Saving Result ## ## ## ## ## ## ## ## ## ## ## ## ## ## ##
output_path = "/dss/dsshome1/0C/ra67jip2/llm-consistency/data/res2_shuffled_raw.csv"
results = questions_df.drop(columns=['llm_prompt'])
results.to_csv(output_path, index=False)
print(f"\nResults saved to {output_path}")
...
## Saving Result ## ## ## ## ## ## ## ## ## ## ## ## ## ## ##
output_path = "/dss/dsshome1/0C/ra67jip2/llm-consistency/data/res3_shuffled_raw.csv"
results = questions_df.drop(columns=['llm_prompt'])
results.to_csv(output_path, index=False)
print(f"\nResults saved to {output_path}")
...
## Saving Result ## ## ## ## ## ## ## ## ## ## ## ## ## ## ##
output_path = "/dss/dsshome1/0C/ra67jip2/llm-consistency/data/res4_shuffled_raw.csv"
results = questions_df.drop(columns=['llm_prompt'])
results.to_csv(output_path, index=False)
print(f"\nResults saved to {output_path}")
